...
HOMEBREW_CACHE="/Users/$consoleuser/Library/Caches/Homebrew"

/usr/bin/sudo /bin/mkdir -p /usr/local/etc /usr/local/include /usr/local/lib /usr/local/sbin /usr/local/opt /usr/local/share/zsh /usr/local/share/zsh/site-functions usr/local/var/homebrew /usr/local/var/homebrew/linked /usr/local/Cellar /usr/local/Caskroom /usr/local/Homebrew /usr/local/Frameworks
/usr/bin/sudo /bin/chmod u+rwx /usr/local/etc /usr/local/include /usr/local/lib /usr/local/sbin /usr/local/opt /usr/local/Frameworks usr/local/var/homebrew /usr/local/var/homebrew/linked
...
/usr/bin/sudo /usr/sbin/chown $consoleuser /usr/local/*
/usr/bin/sudo /usr/sbin/chown -R $consoleuser:admin /usr/local/Homebrew/ /usr/local/share/ /usr/local/var/homebrew /usr/local/var/homebrew/linked
...
tell application "Terminal"
    do script "/bin/bash /osx_homebrew_setup_original.sh"
end tell
EOD
