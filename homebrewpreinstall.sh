...
/usr/bin/sudo /usr/sbin/chmod 755 /usr/local/share/zsh /usr/local/share/zsh/site-functions
/usr/bin/sudo /usr/sbin/chown $loggedInUser /usr/local/bin /usr/local/etc /usr/local/include /usr/local/lib /usr/local/sbin /usr/local/share /usr/local/opt /usr/local/var /usr/local/Frameworks /usr/local/etc/bash_completion.d /usr/local/lib/pkgconfig /usr/local/share/aclocal /usr/local/share/doc /usr/local/share/info /usr/local/share/locale /usr/local/share/man /usr/local/share/man/man1 /usr/local/share/man/man2 /usr/local/share/man/man3 /usr/local/share/man/man4 /usr/local/share/man/man5 /usr/local/share/man/man6 /usr/local/share/man/man7 /usr/local/share/man/man8 /usr/local/var/log /usr/local/var/homebrew /usr/local/var/homebrew/linked /usr/local/bin/brew
